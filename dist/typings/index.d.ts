...
export { SberidSDK, SberidSDKErrorResult, SberidSDKSuccessResult, SberidSDKProps, } from './sberid-sdk';
 ...
 */
export default function createSberidSDK(options: SberidSDKProps): SberidSDK;
