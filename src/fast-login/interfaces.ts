...
export type FastAuthorizationSuccessResponse = {
    success: boolean;
    data: SberidSDKSuccessResult;
};

export type FastAuthorizationErrorResponse = {
    success: boolean;
    data: SberidSDKErrorResult;
};

export declare type FastAuthorizationResponse =
    | FastAuthorizationSuccessResponse
    | FastAuthorizationErrorResponse;
...
export type MessageToParent =
    ...
    | {type: 'success'; data: FastAuthorizationSuccessResponse}
    | {type: 'error'; data: FastAuthorizationErrorResponse};

export type MessageToIframe = {type: 'fetch data'};

export type Message = MessageToParent | MessageToIframe;
